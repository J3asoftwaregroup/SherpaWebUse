...
public class AvenantByPointVenteRow {
	...
	public String getNomRsClient() {
		if(getClient() instanceof Morale){
			nomRsClient = getClient().getNomRaisonSociale();	
				}
		if(getClient() instanceof Physique){
			nomRsClient = ((Physique)getClient()).getNomRaisonSociale();	
				}
		return nomRsClient;
	}
	...
	public String getPrenomClient() {
		...
		if(getClient() instanceof Physique){
			prenomClient = ((Physique)getClient()).getPrenomPers();	
				}
